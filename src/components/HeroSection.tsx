    ...
    <section className="relative min-h-screen bg-gradient-to-br from-pilates-lilac-50 via-white to-pilates-purple-50 overflow-hidden pb-0">
      ...
      <div className="container mx-auto px-4 py-16 relative z-10">
        <div className="flex flex-col-reverse lg:flex-row items-center justify-between gap-12 min-h-[80vh]">
          ...
          {/* Video */}
          <div className="flex-1 animate-fade-in order-1 lg:order-2 w-full">
            <div
              id="ifr_65dfc9439d07100008c4f625_wrapper"
              className="w-full"
              style={{ margin: "0 auto" }}
            >
              <div
                id="ifr_65dfc9439d07100008c4f625_aspect"
              ...
              >
                <iframe
                  ...
                  id="ifr_65dfc9439d07100008c4f625"
                  style={{
                    position: "absolute",
                    top: 0,
                    left: 0,
